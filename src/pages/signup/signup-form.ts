const formEmailPsw = `
  <div class="form-email-psw">
    <div class="form-email">
      ...
      <input class="form-email_input email" type="text" id="email" name="email" required></input>
    </div>
    <div class="form-psw">
      <label class="form-psw_label" for="psw">Password*</label>
      <input class="form-psw_input psw" type="password" id="psw" name="psw" required></input>
    </div>
  </div>
`;
...
const formNameDob = `
  <div class="form-name-dob">
    <div class="form-name">
      ...
      <input class="form-first-name_input first-name" type="text" id="first-name" name="first-name" required></input>
      <label class="form-last-name_label" for="last-name">Last name*</label>
      <input class="form-last-name_input last-name" type="text" id="last-name" name="last-name" required></input>
    </div>
    <div class="form-dob">
...
const formBillingAddress = `
  <div class="form-billing-address">
    ...
    <input class="form-street_input street_bill" type="text" id="street" name="street" required></input>
    <label class="form-city_label" for="city">City*</label>
    <input class="form-city_input city_bill" type="text" id="city" name="city" required></input>
    ...
    <input class="form-country_input country_bill" type="text" id="country" name="country" required></input>
...
const formShippinAddress = `
  <div class="form-shipping-address">
    ...
    <label class="form-street_label" for="street">Street*</label>
    <input class="form-street_input street_ship" type="text" id="street" name="street" required></input>
    <label class="form-city_label" for="city">City*</label>
    <input class="form-city_input city_ship" type="text" id="city" name="city" required></input>
    <label class="form-postalCode_label" for="postalCode">Postal code*</label>
    <input class="form-postalCode_input post_ship" type="text" id="postalCode" name="postalCode" required></input>
    <label class="form-country_label for="country"">Country*</label>
    <input class="form-country_input country_ship" type="text" id="country" name="country" required></input>
    <div class="form-default_checkbox">
